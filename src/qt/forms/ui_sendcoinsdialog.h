...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 REEF"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 REEF"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 REEF"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 REEF"));
        ...
        labelBalance->setText(QStringLiteral("123.456 REEF"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for reef transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for reef transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
