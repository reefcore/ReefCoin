...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
	    ...
	    case SPORK_16_DEVFUND_PAYMENT_ENFORCEMENT:      r = SPORK_16_DEVFUND_PAYMENT_ENFORCEMENT_DEFAULT; break;
            case SPORK_17_BAD_POOL_ENFORCEMENT:             r = SPORK_17_BAD_POOL_ENFORCEMENT_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_17_BAD_POOL_ENFORCEMENT:    		return SPORK_17_BAD_POOL_ENFORCEMENT_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_BAD_POOL_ENFORCEMENT")             return SPORK_17_BAD_POOL_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_17_BAD_POOL_ENFORCEMENT:             return "SPORK_17_BAD_POOL_ENFORCEMENT";
        default:
